...
void linearSearchNama(Motor *m,int jml,string nama){
    bool ketemu=false;
    for(int i=0;i<jml;i++){
        if((m+i)->nama==nama){
...
void binarySearchHarga(Motor *m,int jml,int harga){
    int kiri=0;
    int kanan=jml-1;
    bool ketemu=false;
